...
```
compile 'org.wisepersist:gwt-uploader:1.2.1'
```
...
If you would like to use the 1.2.2-SNAPSHOT release, use this configuration.

For Gradle projects:

```
compile 'org.wisepersist:gwt-uploader:1.2.2-SNAPSHOT'
```
