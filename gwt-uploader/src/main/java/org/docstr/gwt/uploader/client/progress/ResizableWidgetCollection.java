 ...
 * the License.
 */
package org.docstr.gwt.uploader.client.progress;
...
public class ResizableWidgetCollection
    implements WindowResizeListener, Iterable<ResizableWidget> {
   ...
   */
  private Map<ResizableWidget, ResizableWidgetInfo>
      widgets =
      new HashMap<ResizableWidget, ResizableWidgetInfo>();
   ...
   * Constructor.
   *
   * @param resizeCheckDelay The resize check delay.
   * @param resizeCheckingEnabled If the resize checking is enabled or not.
   */
