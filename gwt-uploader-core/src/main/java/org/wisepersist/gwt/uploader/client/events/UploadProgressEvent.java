 ...
 */
public class UploadProgressEvent extends AbstractUploadEvent {
   ...
   */
  public UploadProgressEvent(final File file, final long bytesComplete, final long bytesTotal) {
    super(file);
   ...
   */
  public final long getBytesComplete() {
