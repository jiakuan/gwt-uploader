 ...
 * register it via the {@link Uploader#setFileDialogCompleteHandler(FileDialogCompleteHandler)}
...
public class FileDialogCompleteEvent {
   ...
   */
  public FileDialogCompleteEvent(final int numberOfFilesSelected, final int numberOfFilesQueued,
                                 final int totalFilesInQueue) {
   ...
   */
  public final int getNumberOfFilesQueued() {
   ...
   */
  public final int getNumberOfFilesSelected() {
   ...
   *
   * @return Number of total files in queue.
   */
