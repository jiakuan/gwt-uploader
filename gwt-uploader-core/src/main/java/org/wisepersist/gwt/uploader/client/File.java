 ...
 *
 * <p>Note that, by default, the SWFUpload "Speed" plugin is enabled, providing access to
 * additional metrics on this object such as {@link #getAverageSpeed()},
 * {@link #getPercentUploaded()}, etc.
 *
...
public final class File extends JavaScriptObject {
   ...
   * E.g. {@link org.wisepersist.gwt.uploader.client.events.UploadProgressEvent#getFile()}.
   */
  protected File() {
  }
