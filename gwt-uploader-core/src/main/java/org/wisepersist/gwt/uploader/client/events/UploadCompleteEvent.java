 ...
 * UploadCompleteHandler} and register it via the {@link org.wisepersist.gwt.uploader.client
 ...
 */
public class UploadCompleteEvent extends AbstractUploadEvent {
   ...
   */
  public UploadCompleteEvent(final File file) {
    super(file);
  }
}
