 ...
 * </pre>
 *
 * <p>Note that the 'fileQueueError' event is fired for each file that was not queued after the File
 ...
 *
 * <p>See the documentation on the {@link FileQueueErrorEvent} class for more details on the data
...
public interface FileQueueErrorHandler {
   ...
   * the {@link org.wisepersist.gwt.uploader.client.events.FileQueueErrorEvent} class for more
