 ...
 * events.
 *
 * <p>Note that the 'uploadStart' event is called immediately before the file is uploaded. This
 * event provides an opportunity to perform any last minute validation, add post params or do any
 * other work before the file is uploaded.
 *
 * <p>The uploader can be cancelled by returning 'false' from uploadStart in the handler. If you
 * return 'true' or do not return any value then the uploader proceeds. Returning 'false' will
 * cause an uploadError event to fired.
 *
 * @author delight.wjk@gmail.com
 */
public class UploadStartEvent extends AbstractUploadEvent {
   ...
   */
  public UploadStartEvent(final File file) {
    super(file);
  }
